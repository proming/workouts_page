...
class CalendarDrawer(TracksDrawer):
    ...
    def _draw(self, dr: svgwrite.Drawing, size: XY, offset: XY, year: int) -> None:
        ...
        day_style = f"dominant-baseline: central; font-size:{min_size * 1.0 / 80.0}px; font-family:Source Han Sans CN;"
        day_length_style = f"font-size:{min_size * 1.0 / 80.0}px; font-family:Source Han Sans CN;"
